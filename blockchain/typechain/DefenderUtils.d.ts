...
interface DefenderUtilsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getSlots(uint256)": FunctionFragment;
    "grantRole(bytes32,address)": FunctionFragment;
    "hasRole(bytes32,address)": FunctionFragment;
    "renounceRole(bytes32,address)": FunctionFragment;
    "revokeRole(bytes32,address)": FunctionFragment;
    "supportsInterface(bytes4)": FunctionFragment;
    "updateWinTracker(uint256,bool)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "updateWinTracker",
...
export class DefenderUtils extends BaseContract {
  ...
  interface: DefenderUtilsInterface;
