        ...
        for (let y = 0; y < size; y++) {
            for (let x = 0; x < size; x++) {                
                ...
                if (x === 0 || x === lastCol) {
                    ...
                    if (((hallways[DIR_LEFT]  && x === 0) || (hallways[DIR_RIGHT] && x === lastCol)) && y >= halfSize - 2 && y <= halfSize + 1) {
                        continue;
                    }
                } else if (y === 0) {
                    // top
            ...
            for (let x = 0; x < DUNGEON_SIZE; x++) {
                ...
                switch (cell.roomType) {
                    ...
                    case RoomType.BOSS_ROOM:
                        ...
                        this.treasureChest.create(this, this.gameLayer, pos.x, pos.y, () => alert('completed'))
                        break;
                }
